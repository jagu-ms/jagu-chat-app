...
export class ChatProvider extends React.Component {
    //Connect to socket io and the operations with it.
    connect = async () => {
        ...
        render(){
            return (
                <ChatContext.Consumer>
                    ...
                    {/* what is the chat prop and parameter role */}
                </ChatContext.Consumer>
            );
        }
    }
